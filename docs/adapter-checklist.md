...
- Read the full MQTT payload spec in `docs/interfaces/mqtt-publisher-guide.md` (SSOT)
...
4. **Update `docs/interfaces/mqtt-publisher-guide.md`** with the full payload format (SSOT — code and this doc must stay in sync)
...
- `docs/interfaces/mqtt-publisher-guide.md` — Full MQTT payload specifications (SSOT)
